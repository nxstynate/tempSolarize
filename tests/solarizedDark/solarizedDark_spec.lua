require("plenary.reload").reload_module("solarizedDark", true)
local solarizedDark = require("solarizedDark")
local default = solarizedDark.config

describe("setup", function()
  it("works with default values", function()
    solarizedDark.setup()
    assert.are.same(solarizedDark.config, default)
  end)
  ...
  it("works with old italic values", function()
    ...
    solarizedDark.setup({ italic = true })
    assert.are.same(solarizedDark.config, expected)
  end)
  ...
  it("works with config overrides", function()
    ...
    solarizedDark.setup({ undercurl = false, underline = false })
    assert.are.same(solarizedDark.config, expected)
  end)
end)
